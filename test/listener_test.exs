defmodule Telebrew.ListenerTest do
  ...
  test "events and commands work" do
    ...
    #test photo event
    send_test_message(photo: [%{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"}])
    assert_receive :photo, 10_000

    #test document event
    send_test_message(document: %{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"})
    assert_receive :default, 10_000

    #test voice event
    send_test_message(voice: %{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"})
    assert_receive :voice, 10_000

    #test video_note event
    send_test_message(video_note: %{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"})
    ...
    # test audio event
    send_test_message(audio: %{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"})
    assert_receive :audio, 10_000

    # test sticker event
    send_test_message(sticker: %{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"})
    assert_receive :sticker, 10_000

    # test video event
    send_test_message(video: %{file_id: "AgADAQADvKcxGzsuyEafayseChLXzWl6DDAABPfPNmzjDkSjmV4AAgI"})
